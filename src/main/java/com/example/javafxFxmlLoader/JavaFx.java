...
public class JavaFx {
    public static Stage SceneSwitcher(String PathToFXML) {
        ...
        loader.setLocation(JavaFx.class.getResource(PathToFXML));
    ...
    public static Stage showInputErrorNotification(String Error) {
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(JavaFx.class.getResource("/ErrorNotification.fxml"));
    ...
    public static Stage showInputSuccessfulNotification(String SuccessfulMessage) {
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(JavaFx.class.getResource("/SuccessfulNotification.fxml"));
